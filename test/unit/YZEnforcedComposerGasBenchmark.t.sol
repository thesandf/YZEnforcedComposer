...
contract YZEnforcedComposerGasBenchmarkTest is YZEnforcedComposerBase {
    ...
    uint256 internal constant MAX_TEST_AMOUNT = 30000 ether;
    ...
    function test_GasBenchmark_PauseControlOperations() public {
        ...
        assertLt(gasUsed, 50000, "pauseDeposits gas usage too high");
        ...
        assertLt(gasUsed, 50000, "unpauseDeposits gas usage too high");
        ...
        assertLt(gasUsed, 50000, "pauseRedemptions gas usage too high");
        ...
        assertLt(gasUsed, 50000, "unpauseRedemptions gas usage too high");
    ...
    function test_GasBenchmark_WhitelistOperations() public {
        ...
        assertLt(gasUsed, 50000, "setWhitelistEnabled gas usage too high");
        ...
        assertLt(gasUsed, 50000, "setWhitelist gas usage too high");
        ...
        assertLt(gasUsed, 100000, "batchSetWhitelist gas usage too high");
    ...
    function test_GasBenchmark_ViewOperations() public {
        ...
        gasBefore = gasleft();
        yzEnforcedComposer_arb.getUserAssets(userA);
        gasAfter = gasleft();
        gasUsed = gasBefore - gasAfter;
        ...
        gasBefore = gasleft();
        yzEnforcedComposer_arb.canDeposit(userA, BENCHMARK_AMOUNT);
        gasAfter = gasleft();
        gasUsed = gasBefore - gasAfter;
    ...
    function test_GasBenchmark_EmergencyOperations() public {
        ...
        assetOFT_arb.approve(address(vault_arb), BENCHMARK_AMOUNT);

        vm.prank(address(yzEnforcedComposer_arb));
        vault_arb.deposit(BENCHMARK_AMOUNT, address(yzEnforcedComposer_arb));
    ...
    function test_PerformanceRegression_DepositScaling() public {
        _setupUserCap(userA, 30000 ether);
        _setupTVLCap(30000 ether);
        ...
        for (uint256 i = 0; i < depositAmounts.length; i++) {
            emit log_named_uint(
                string(abi.encodePacked("Deposit ", Strings.toString(depositAmounts[i]), " Gas")), gasUsages[i]
            );
        }
    }
    ...
    function test_PerformanceRegression_CapOperationsScaling() public {
        ...
        for (uint256 idx = 0; idx < userCounts.length; idx++) {
            ...
            gasUsages[idx] = gasBefore - gasAfter;
    ...
    function test_GasOptimization_CalldataEfficiency() public {
        ...
        assertLt(gasUsed, 600000, "Calldata processing too gas expensive");
